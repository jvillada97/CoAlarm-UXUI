...
class edit_alarm : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonUpdateAlarm: Button = findViewById(R.id.buttonEditAlarm)
    ...
    private fun showTimePicker(onTimeSelected: (String) -> Unit) {
        ...
        picker.dialog?.let { dialog ->
            ...
            val switchModeButton =
                dialog.findViewById<View>(com.google.android.material.R.id.material_timepicker_mode_button)
            switchModeButton?.visibility = View.GONE

            val cancelButton =
                dialog.findViewById<View>(com.google.android.material.R.id.material_timepicker_cancel_button)
            ...
            val timePickerView =
                dialog.findViewById<View>(com.google.android.material.R.id.material_timepicker_view)
            timePickerView?.let { view ->
                val hourLabel =
                    view.findViewById<View>(com.google.android.material.R.id.material_label)
    ...
    private fun showUpdateConfirmationDialog() {
        ...
        titleTextView.text = "Tu alarma ha sido actualizada"
